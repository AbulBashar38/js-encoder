  ...
  return (
    <div id="about" className="hero lg:min-h-screen  bg-base-200 text-neutral">
      <div className="hero-content flex-col lg:flex-row">
        <img
          src={aboutImg}
          className="lg:max-w-md sm:max-w-sm rounded-lg shadow-2xl"
          alt="aboutImg"
        />
        <div className="lg:sp-10">
          <h1 className="lg:text-5xl text-4xl font-bold">
            About JS <span className="text-primary">Encoder</span>
          </h1>
          <p className="py-6 lg:text-lg">
            ...
            official December in 2022 with a focus on small online business. we
            try to evolved as a large online marketing firm. Now, we at
            JSEncoder, provides various internet marketing services for small
            and medium-sized business to enterprise brands across the globe with
          ...
          <div className=" grid grid-cols-2 lg:gap-8 gap-2">
            ...
            >
              <div className="lg:card-body p-5">
                <h2 className="lg:card-title font-bold text-lg">
                  We Are JS <span className="text-primary">Encoder</span>
                </h2>
                <p className="lg:text-md ">
                  ...
                  our clients to ensure that the objectives are met by our
                  proven strategies.
                </p>
              </div>
            </div>
            ...
            >
              <div className="lg:card-body p-5">
                <h2 className="lg:card-title font-bold text-lg">
                  How We <span className="text-primary">Formed</span>
                </h2>
                <p className="lg:text-md">
